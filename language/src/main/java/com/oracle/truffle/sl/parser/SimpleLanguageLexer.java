...
public class SimpleLanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"OP_SEQ", "OP_CONS", "OP_OR", "OP_AND", "OP_COMPARE", "OP_ADD", "OP_MUL", 
			"LETTER", "LLETTER", "ULETTER", "NON_ZERO_DIGIT", "DIGIT", "HEX_DIGIT", 
			"OCT_DIGIT", "BINARY_DIGIT", "TAB", "STRING_CHAR", "CHAR", "IDENTIFIER", 
			"UIDENTIFIER", "STRING_LITERAL", "CHAR_LITERAL", "NUMERIC_LITERAL"
		};
	}
