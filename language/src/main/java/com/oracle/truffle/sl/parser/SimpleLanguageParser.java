...
public class SimpleLanguageParser extends Parser {
	...
	public final Array_expressionContext array_expression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8725741510628902L) != 0)) {
				{
				setState(276);
				expr_list();
				}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class FalseLiteralContext extends FactorContext {
		public FalseLiteralContext(FactorContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleLanguageVisitor ) return ((SimpleLanguageVisitor<? extends T>)visitor).visitFalseLiteral(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	@SuppressWarnings("CheckReturnValue")
	public static class TrueLiteralContext extends FactorContext {
		public TrueLiteralContext(FactorContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleLanguageVisitor ) return ((SimpleLanguageVisitor<? extends T>)visitor).visitTrueLiteral(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public static final String _serializedATN =
		...
		"3\u00053\u01b3\b3\n3\f3\u01b6\t3\u00033\u01b8\b3\u00013\u00013\u00013"+
		"\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00033\u01c5"+
		"\b3\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00013\u00053\u01cf"+
		"\b3\n3\f3\u01d2\t3\u00033\u01d4\b3\u00013\u00013\u00013\u00013\u00013"+
		"\u00013\u00053\u01dc\b3\n3\f3\u01df\t3\u00013\u0000\u0001f4\u0000\u0002"+
		"\u0004\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016\u0018\u001a\u001c\u001e"+
		" \"$&(*,.02468:<>@BDFHJLNPRTVXZ\\^`bdf\u0000\u0000\u01f3\u0000h\u0001"+
		"\u0000\u0000\u0000\u0002k\u0001\u0000\u0000\u0000\u0004}\u0001\u0000\u0000"+
		"\u0000\u0006\u0082\u0001\u0000\u0000\u0000\b\u008f\u0001\u0000\u0000\u0000"+
		"\n\u0094\u0001\u0000\u0000\u0000\f\u009a\u0001\u0000\u0000\u0000\u000e"+
		"\u00a0\u0001\u0000\u0000\u0000\u0010\u00aa\u0001\u0000\u0000\u0000\u0012"+
