...
public class SimpleLanguageParser extends Parser {
	...
	public static final int
		...
		T__24=25, T__25=26, WS=27, COMMENT=28, LINE_COMMENT=29, OP_SEQ=30, OP_OR=31, 
		OP_AND=32, OP_COMPARE=33, OP_ADD=34, OP_MUL=35, IDENTIFIER=36, STRING_LITERAL=37, 
		NUMERIC_LITERAL=38;
	public static final int
		...
		RULE_logic_factor = 18, RULE_arithmetic = 19, RULE_term = 20, RULE_skip_expression = 21, 
		RULE_factor = 22, RULE_member_expression = 23;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"arithmetic", "term", "skip_expression", "factor", "member_expression"
		};
	}
	...
	public final Return_statementContext return_statement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 481040801796L) != 0)) {
				{
				setState(144);
				expression();
				}
	...
	public final Skip_expressionContext skip_expression() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_skip_expression);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(194);
	...
	public final Member_expressionContext member_expression() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_member_expression);
		int _la;
		try {
			setState(234);
			_errHandler.sync(this);
