...
public class SimpleLanguageParser extends Parser {
	...
	public static final int
		...
		RULE_case_expression = 44, RULE_lambda_expression = 45, RULE_factor = 46, 
		RULE_member_expression = 47;
	...
	public final Array_expressionContext array_expression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6473941645039110L) != 0)) {
				{
				setState(245);
				expr_list();
				}
	...
	private FactorContext factor(int _p) throws RecognitionException {
		...
		int _startState = 92;
		enterRecursionRule(_localctx, 92, RULE_factor, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Member_expressionContext member_expression() throws RecognitionException {
		...
		enterRule(_localctx, 94, RULE_member_expression);
		int _la;
		try {
			setState(429);
			_errHandler.sync(this);
