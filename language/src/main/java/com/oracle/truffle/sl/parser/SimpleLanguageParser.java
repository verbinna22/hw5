...
public class SimpleLanguageParser extends Parser {
	...
	public static final int
		...
		UIDENTIFIER=32, STRING_LITERAL=33, NUMERIC_LITERAL=34;
	public static final int
		...
		RULE_array_expression = 19, RULE_sexp_expression = 20, RULE_factor = 21, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"array_expression", "sexp_expression", "factor", "member_expression"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"OP_MUL", "IDENTIFIER", "UIDENTIFIER", "STRING_LITERAL", "NUMERIC_LITERAL"
		};
	}
	...
	public final Array_expressionContext array_expression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 32213079556L) != 0)) {
				{
				setState(195);
				expr_list();
				}
